...
function Home() {
  ...
  return (
    <main className="min-h-dvh overflow-hidden bg-background">
      ...
      <footer className="border-t border-border bg-card px-6 py-8 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 text-sm text-muted-foreground sm:flex-row"><p>© 2026 ELEVIQ Prep. Educational readiness support, not a guarantee of exam results.</p><div className="flex flex-wrap gap-5"><a href="mailto:info@eleviqprep.com" className="transition-colors hover:text-primary">info@eleviqprep.com</a><Link to="/privacy" className="transition-colors hover:text-primary">Privacy</Link><Link to="/terms" className="transition-colors hover:text-primary">Terms</Link></div></div></footer>
