...
import { checkEmailLegitimacy, checkStudentLockout, recordStudentAuthAttempt, verifyTemporaryPassword } from '@/lib/auth-security-api'
        ...
        if (!adminIntent) {
          ...
          if (currentLockout.locked) {
            try {
              ...
              setError(currentLockout.message || 'This student portal is locked for 8 hours. An administrator must send a temporary password before access can be restored.')
              return
            }
          }
        }
